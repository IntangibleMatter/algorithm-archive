...
[import:24-36, lang:"gdscript"](code/gdscript/1d_convolution.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import:10-11, lang:"gdscript"](code/gdscript/1d_convolution.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import:13-14, lang:"gdscript"](code/gdscript/1d_convolution.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import:30-30, lang:"gdscript"](code/gdscript/1d_convolution.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import:39-53, lang:"gdscript"](code/gdscript/1d_convolution.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import:, lang:"gdscript"](code/gdscript/1d_convolution.gd)
{% endmethod %}
