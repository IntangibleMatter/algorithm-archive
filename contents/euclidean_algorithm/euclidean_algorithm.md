...
[import:20-35, lang="gdscript"](code/gdscript/euclidian.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import:9-18, lang="gdscript"](code/gdscript/euclidian.gd)
{% endmethod %}
...
{% sample lang="gdscript" %}
[import, lang="gdscript"](code/gdscript/euclidian.gd)
{% endmethod %}
